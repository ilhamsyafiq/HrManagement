        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700 flex items-center gap-2">
                    ...
                    <h3 class="text-base font-semibold text-gray-800 dark:text-gray-200">Internship Overview</h3>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Supervisor Info -->
                        <div class="rounded-xl bg-gray-50 dark:bg-gray-700 border border-gray-100 dark:border-gray-600 p-5">
                            <h4 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3">Supervisor</h4>
                            @if(Auth::user()->supervisor)
                                <div class="space-y-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ Auth::user()->supervisor->name }}</span>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <svg class="w-4 h-4 text-gray-400 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/></svg>
                                        <span class="text-sm text-gray-600 dark:text-gray-400">Email:</span>
                                        <span class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ Auth::user()->supervisor->email }}</span>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ Auth::user()->supervisor->department->name ?? 'N/A' }}</span>
                                    </div>
                                </div>
                            @else
                                <p class="text-sm text-gray-400 dark:text-gray-500 italic">No supervisor assigned.</p>
                            @endif
                        </div>

                        <!-- Internship Period -->
                        <div class="rounded-xl bg-gray-50 dark:bg-gray-700 border border-gray-100 dark:border-gray-600 p-5">
                            <h4 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3">Internship Period</h4>
                            <div class="space-y-2">
                                <div class="flex items-center gap-2">
                                    <svg class="w-4 h-4 text-gray-400 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5"/></svg>
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Start:</span>
                                    <span class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ Auth::user()->internship_start_date ? Auth::user()->internship_start_date->format('M d, Y') : 'N/A' }}</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <svg class="w-4 h-4 text-gray-400 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5"/></svg>
                                    <span class="text-sm text-gray-600 dark:text-gray-400">End:</span>
                                    <span class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ Auth::user()->internship_end_date ? Auth::user()->internship_end_date->format('M d, Y') : 'N/A' }}</span>
                                </div>
            ...
            <div class="rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-base font-semibold text-gray-800 dark:text-gray-200">Report Statistics</h3>
                    </div>
            ...
            <div class="rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-base font-semibold text-gray-800 dark:text-gray-200">My Reports</h3>
                    </div>
                    <a href="{{ route('reports.index') }}" class="text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 transition">View All &rarr;</a>
                </div>
                <div class="p-6">
                    @if(session('success'))
                        <div class="flex items-center gap-2 bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300 px-4 py-3 rounded-xl mb-4 text-sm">
                    ...
                    @if(session('error'))
                        <div class="flex items-center gap-2 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 px-4 py-3 rounded-xl mb-4 text-sm">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                @forelse($reports as $report)
                                    <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700 transition">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">{{ $report->title }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{{ $report->created_at->format('M d, Y') }}</td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                            <a href="{{ route('reports.show', $report->id) }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300">View</a>

                                            @if($report->status == 'draft' || $report->status == 'revised' || $report->status == 'rejected')
                                                {{-- Draft/Revised/Rejected: can edit and submit --}}
                                                <a href="{{ route('reports.edit', $report->id) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300">Edit</a>
                                                <form action="{{ route('reports.submit', $report->id) }}" method="POST" class="inline">
                                                    @csrf
                                                    <button type="submit" class="text-emerald-600 dark:text-emerald-400 hover:text-emerald-900 dark:hover:text-emerald-300" onclick="return confirm('Submit this report to your supervisor?')">
                                                        Submit
                                                    </button>
                                                </form>
                                            @endif
                                            ...
                                            @if($report->status == 'signed' && $report->signed_path)
                                                ...
                                                <a href="{{ route('reports.download-signed', $report->id) }}" class="text-emerald-600 dark:text-emerald-400 hover:text-emerald-900 dark:hover:text-emerald-300 font-semibold">Download Signed</a>
                                            @endif

                                            <a href="{{ route('reports.download', $report->id) }}" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200">Download Original</a>

                                            @if($report->status == 'draft')
                                                <form action="{{ route('reports.destroy', $report->id) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300" onclick="return confirm('Delete this report?')">Delete</button>
                                                </form>
                                            @endif
                                        </td>
                                    </tr>
                                    ...
                                    @if(($report->status == 'rejected' || $report->status == 'revised') && $report->comments)
                                        <tr class="bg-red-50/60 dark:bg-red-900/20">
                                            <td colspan="4" class="px-6 py-3 text-sm text-red-700 dark:text-red-300">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-8 text-center text-gray-400 dark:text-gray-500">
                                            ...
                                            No reports yet.
                                            <a href="{{ route('reports.create') }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 ml-1 font-medium">Submit your first report</a>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                ...
                <div class="p-6">
                    @if(auth()->user()->shift)
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="rounded-xl bg-gray-50 dark:bg-gray-700 border border-gray-100 dark:border-gray-600 p-4">
                                <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Shift</p>
                                <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ auth()->user()->shift->name }}</p>
                            </div>
                            <div class="rounded-xl bg-gray-50 dark:bg-gray-700 border border-gray-100 dark:border-gray-600 p-4">
                                <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Hours</p>
                                <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ auth()->user()->shift->start_time->format('H:i') }} &ndash; {{ auth()->user()->shift->end_time->format('H:i') }}</p>
                            </div>
                        </div>
                    @else
                        <p class="text-sm text-gray-400 dark:text-gray-500 italic">No shift assigned</p>
                    @endif
                </div>
            </div>
                ...
                <div class="p-6">
                    @if($todayAttendance)
                        ...
                        @if($todayAttendance->location_flagged)
                            <div class="mb-4 flex items-center gap-2 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 text-amber-800 dark:text-amber-300 px-4 py-3 rounded-xl text-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="rounded-xl bg-gray-50 dark:bg-gray-700 border border-gray-100 dark:border-gray-600 p-4">
                                <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Clock In</p>
                                <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ $todayAttendance->clock_in ? $todayAttendance->clock_in->format('H:i') : 'Not yet' }}</p>
                                @if($todayAttendance->clock_in_address)
                                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">{{ $todayAttendance->clock_in_address }}</p>
                                @endif
                            </div>
                            <div class="rounded-xl bg-gray-50 dark:bg-gray-700 border border-gray-100 dark:border-gray-600 p-4">
                                <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Clock Out</p>
                                <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ $todayAttendance->clock_out ? $todayAttendance->clock_out->format('H:i') : 'Not yet' }}</p>
                                @if($todayAttendance->clock_out_address)
                                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">{{ $todayAttendance->clock_out_address }}</p>
                                @endif
                            </div>
                            <div class="rounded-xl bg-gray-50 dark:bg-gray-700 border border-gray-100 dark:border-gray-600 p-4">
                                <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Total Hours</p>
                                <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ $todayAttendance->formatted_work_hours }}</p>
                            </div>
                        </div>
                            ...
                            <div class="mt-5">
                                ...
                                <div class="space-y-2">
                                    @foreach($todayAttendance->breaks as $break)
                                        <div class="flex items-center gap-3 text-sm bg-gray-50 dark:bg-gray-700 border border-gray-100 dark:border-gray-600 rounded-lg px-4 py-2.5">
                                            <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-indigo-100 dark:bg-indigo-900 text-indigo-600 dark:text-indigo-300 text-xs font-bold">{{ $loop->iteration }}</span>
                                            ...
                                            <span class="text-gray-400 dark:text-gray-500">({{ $break->duration_minutes ? number_format($break->duration_minutes / 60, 2) . 'h' : 'N/A' }})</span>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                    ...
                    @else
                        <div class="text-center py-6">
                            <svg class="w-10 h-10 mx-auto mb-2 text-gray-300 dark:text-gray-600" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                @foreach($recentAttendances as $attendance)
                                    <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700 transition">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">{{ $attendance->date->format('M d, Y') }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">{{ $attendance->clock_in ? $attendance->clock_in->format('H:i') : '-' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">{{ $attendance->clock_out ? $attendance->clock_out->format('H:i') : '-' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">{{ $attendance->formatted_work_hours }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="flex items-center justify-center w-10 h-10 rounded-full bg-indigo-50 dark:bg-indigo-900/40">
                                <span class="text-lg font-bold text-indigo-600 dark:text-indigo-300">{{ $pendingLeaves }}</span>
                            </div>
                            <p class="text-sm text-gray-600 dark:text-gray-400">pending leave {{ $pendingLeaves == 1 ? 'application' : 'applications' }}</p>
                        </div>
                        <a href="{{ route('leave.index') }}" class="inline-flex items-center gap-1.5 text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 transition">
                            View Leaves
