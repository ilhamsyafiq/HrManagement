<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <!-- WFH Toggle -->
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center">
                        <svg class="w-5 h-5 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    </div>
                    <div>
                        <p class="text-sm font-semibold text-gray-800 dark:text-gray-200">Work From Home</p>
                        <p class="text-xs text-gray-400 dark:text-gray-500">Toggle if you're working remotely today</p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <!-- Clock In -->
                <button id="clock-in-btn" class="group relative overflow-hidden bg-white dark:bg-gray-800 border-2 border-emerald-200 dark:border-emerald-800 hover:border-emerald-400 dark:hover:border-emerald-600 rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 text-center">
                    <div class="flex flex-col items-center gap-3">
                        <div class="w-14 h-14 rounded-full bg-emerald-100 dark:bg-emerald-900 group-hover:bg-emerald-200 dark:group-hover:bg-emerald-800 flex items-center justify-center transition-colors duration-300">
                            <svg class="w-7 h-7 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"/>
                            </svg>
                        </div>
                        <span class="text-lg font-bold text-gray-800 dark:text-gray-200">Clock In</span>
                        <span class="text-xs text-gray-400 dark:text-gray-500">Start your workday</span>
                    </div>
                </button>

                <!-- Clock Out -->
                <button id="clock-out-btn" class="group relative overflow-hidden bg-white dark:bg-gray-800 border-2 border-red-200 dark:border-red-800 hover:border-red-400 dark:hover:border-red-600 rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 text-center">
                    <div class="flex flex-col items-center gap-3">
                        <div class="w-14 h-14 rounded-full bg-red-100 dark:bg-red-900 group-hover:bg-red-200 dark:group-hover:bg-red-800 flex items-center justify-center transition-colors duration-300">
                            <svg class="w-7 h-7 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/>
                            </svg>
                        </div>
                        <span class="text-lg font-bold text-gray-800 dark:text-gray-200">Clock Out</span>
                        <span class="text-xs text-gray-400 dark:text-gray-500">End your workday</span>
                    </div>
                </button>

                <!-- Start Break -->
                <button id="break-in-btn" class="group relative overflow-hidden bg-white dark:bg-gray-800 border-2 border-amber-200 dark:border-amber-800 hover:border-amber-400 dark:hover:border-amber-600 rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 text-center">
                    <div class="flex flex-col items-center gap-3">
                        <div class="w-14 h-14 rounded-full bg-amber-100 dark:bg-amber-900 group-hover:bg-amber-200 dark:group-hover:bg-amber-800 flex items-center justify-center transition-colors duration-300">
                            <svg class="w-7 h-7 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                        </div>
                        <span class="text-lg font-bold text-gray-800 dark:text-gray-200">Start Break</span>
                        <span class="text-xs text-gray-400 dark:text-gray-500">Take a pause</span>
                    </div>
                </button>

                <!-- End Break -->
                <button id="break-out-btn" class="group relative overflow-hidden bg-white dark:bg-gray-800 border-2 border-orange-200 dark:border-orange-800 hover:border-orange-400 dark:hover:border-orange-600 rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 text-center">
                    <div class="flex flex-col items-center gap-3">
                        <div class="w-14 h-14 rounded-full bg-orange-100 dark:bg-orange-900 group-hover:bg-orange-200 dark:group-hover:bg-orange-800 flex items-center justify-center transition-colors duration-300">
                            <svg class="w-7 h-7 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                        </div>
                        <span class="text-lg font-bold text-gray-800 dark:text-gray-200">End Break</span>
                        <span class="text-xs text-gray-400 dark:text-gray-500">Resume work</span>
                    </div>
                </button>
            </div>
    ...
    <script>
        ...
        function updateTodayStatus(data) {
            ...
            if (data.attendance) {
                ...
                html += '<div class="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ' + (data.attendance.clock_in ? 'bg-emerald-100 dark:bg-emerald-900' : 'bg-gray-100 dark:bg-gray-700') + '">';
                html += '<svg class="w-5 h-5 ' + (data.attendance.clock_in ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-400 dark:text-gray-500') + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"/></svg>';
                html += '</div>';
                html += '<div class="flex-1 min-w-0">';
                html += '<p class="text-sm font-medium text-gray-500 dark:text-gray-400">Clock In</p>';
                if (data.attendance.clock_in) {
                    html += '<p class="text-lg font-semibold text-gray-900 dark:text-gray-100">' + formatTime(data.attendance.clock_in) + '</p>';
                    if (data.attendance.clock_in_address) {
                        html += '<p class="text-xs text-gray-400 dark:text-gray-500 truncate">' + data.attendance.clock_in_address + '</p>';
                    }
                } else {
                    html += '<p class="text-sm text-gray-400 dark:text-gray-500">Not yet</p>';
                }
                html += '</div></div>';

                // Clock Out Row
                html += '<div class="flex items-start gap-4">';
                html += '<div class="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ' + (data.attendance.clock_out ? 'bg-red-100 dark:bg-red-900' : 'bg-gray-100 dark:bg-gray-700') + '">';
                html += '<svg class="w-5 h-5 ' + (data.attendance.clock_out ? 'text-red-600 dark:text-red-400' : 'text-gray-400 dark:text-gray-500') + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg>';
                html += '</div>';
                html += '<div class="flex-1 min-w-0">';
                html += '<p class="text-sm font-medium text-gray-500 dark:text-gray-400">Clock Out</p>';
                if (data.attendance.clock_out) {
                    html += '<p class="text-lg font-semibold text-gray-900 dark:text-gray-100">' + formatTime(data.attendance.clock_out) + '</p>';
                    if (data.attendance.clock_out_address) {
                        html += '<p class="text-xs text-gray-400 dark:text-gray-500 truncate">' + data.attendance.clock_out_address + '</p>';
                    }
                } else {
                    html += '<p class="text-sm text-gray-400 dark:text-gray-500">Not yet</p>';
                }
                ...
                if (data.attendance.clock_out) {
                    html += '<div class="flex items-start gap-4">';
                    html += '<div class="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center bg-indigo-100 dark:bg-indigo-900">';
                    html += '<svg class="w-5 h-5 text-indigo-600 dark:text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>';
                    html += '</div>';
                    html += '<div class="flex-1 min-w-0">';
                    html += '<p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Hours</p>';
                    html += '<p class="text-lg font-semibold text-indigo-600 dark:text-indigo-400">' + formatWorkHours(data.attendance.total_work_hours) + '</p>';
                    html += '</div></div>';
                }

                // Breaks
                if (data.breaks && data.breaks.length > 0) {
                    html += '<div class="border-t border-gray-100 dark:border-gray-700 pt-4 mt-4">';
                    html += '<p class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-3 flex items-center gap-2">';
                    ...
                    data.breaks.forEach((breakItem, index) => {
                        ...
                        html += '<div class="flex items-center justify-between px-3 py-2 rounded-lg ' + (isActive ? 'bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800' : 'bg-gray-50 dark:bg-gray-700') + '">';
                        html += '<div class="flex items-center gap-2">';
                        html += '<span class="text-xs font-medium text-gray-400 dark:text-gray-500">#' + (index + 1) + '</span>';
                        html += '<span class="text-sm text-gray-700 dark:text-gray-300">' + formatTime(breakItem.break_in);
                        if (breakItem.break_out) {
                            html += ' - ' + formatTime(breakItem.break_out);
                        }
                        html += '</span></div>';
                        if (isActive) {
                            html += '<span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-amber-100 dark:bg-amber-900 text-amber-700 dark:text-amber-300"><span class="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse"></span>Active</span>';
                        } else if (breakItem.duration_minutes) {
                            html += '<span class="text-xs text-gray-500 dark:text-gray-400">' + Math.round(breakItem.duration_minutes) + ' min</span>';
                        }
                        html += '</div>';
                    });
                    html += '</div></div>';
                ...
                container.innerHTML = '<div class="text-center py-8"><svg class="w-12 h-12 text-gray-300 dark:text-gray-600 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><p class="text-gray-400 dark:text-gray-500 text-sm">No activity recorded today</p><p class="text-gray-300 dark:text-gray-600 text-xs mt-1">Click "Clock In" to start</p></div>';
