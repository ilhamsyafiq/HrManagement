                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        @if($leave->document_path)
                            <div class="md:col-span-2 bg-gray-50/80 rounded-xl p-4">
                                ...
                                <a href="{{ Storage::url($leave->document_path) }}" target="_blank" class="inline-flex items-center gap-2 text-sm font-medium text-blue-600 hover:text-blue-800 transition-colors duration-150">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
