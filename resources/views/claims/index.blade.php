<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            @if(session('error'))
                <div class="rounded-xl border border-red-200 dark:border-red-900 bg-red-50 dark:bg-red-900/30 px-5 py-4 flex items-center gap-3">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Your Claims</h3>
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-700">
                        <thead>
                            <tr class="bg-gray-50/80 dark:bg-gray-700">
                                ...
                                <th class="px-6 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Amount (RM)</th>
                        ...
                        <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
                            @forelse($claims as $claim)
                                <tr class="hover:bg-gray-50/60 dark:hover:bg-gray-700 transition-colors duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">{{ $claim->title }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">{{ number_format($claim->total_amount, 2) }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">{{ $claim->created_at->format('M d, Y') }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">No claims found. Submit your first claim to get started.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
